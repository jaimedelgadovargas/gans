...
def main():
    ...
    #print('Saved encoder and autoencoder')
    ...
    synth.autoencoder.save(path_output+'autoencoder.keras')
    synth.embedder.save(path_output+'embedder.keras')
    synth.supervisor.save(path_output+'supervisor.keras')
    #print('Saved supervisor')
    ...
    synth.discriminator_model.save(path_output+'discriminator_model.keras')
    synth.adversarial_supervised.save(path_output+'adversarial_supervised.keras')
    synth.adversarial_embedded.save(path_output+'adversarial_embedded.keras')
    synth.generator.save(path_output+'generator.keras')
